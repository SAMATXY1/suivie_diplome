...
class SearchStudentPage extends StatefulWidget {
  SearchStudentPage({required this.saRole , required this.saNom, required this.saEmail});
                            ...
                            builder: (context) {
                              if (widget.saRole == 'S' ||
                                ...
                                return EditDiplomePage(
                                  dipCne: cne,
                                  nomComplet: etName,
                                  saRole: widget.saRole, saNom: saNomF, saEmail: widget.saEmail,
                                );
                              }
                            },
                          ),
